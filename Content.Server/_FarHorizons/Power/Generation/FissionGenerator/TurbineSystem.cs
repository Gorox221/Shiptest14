...
public sealed class TurbineSystem : SharedTurbineSystem
{
    ...
    #region BUI
    private void OnUiOpened(EntityUid uid, TurbineComponent comp, ref BoundUIOpenedEvent args)
    {
        UpdateUI(uid, comp);
    }
    ...
    private void EnsureGasPipes(EntityUid uid, TurbineComponent comp)
    {
